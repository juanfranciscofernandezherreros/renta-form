...
// ---------------------------------------------------------------------------
//  Mock in-memory data store – ported from src/demoData.js
...
// ── Asignaciones declaración ↔ pregunta ──────────────────────────────────
...
// ── Idiomas ───────────────────────────────────────────────────────────────
const idiomasIniciales = [
  { id: 'lang0000-0001-0000-0001-000100010001', code: 'es', label: 'Español', activo: true },
  { id: 'lang0000-0002-0000-0002-000200020002', code: 'ca', label: 'Català', activo: true },
  { id: 'lang0000-0003-0000-0003-000300030003', code: 'en', label: 'English', activo: true },
  { id: 'lang0000-0004-0000-0004-000400040004', code: 'fr', label: 'Français', activo: true },
].map((l) => ({
  ...l,
...
let nextIdiomaIdCounter = idiomasIniciales.length + 1
...
const store = {
  declaraciones: [...declaracionesIniciales],
  preguntasAdicionales: [...preguntasAdicionalesIniciales],
  ...
  users: declaracionesIniciales.map((d) => ({
    dniNie: d.dniNie,
    nombre: d.nombre,
  ...
  blocked: new Map(declaracionesIniciales.map((d) => [d.dniNie, false])),
  reported: new Map(declaracionesIniciales.map((d) => [d.dniNie, false])),
  userPreguntas: new Map(declaracionesIniciales.map((d) => [d.dniNie, []])),
  userSecciones: new Map(declaracionesIniciales.map((d) => [d.dniNie, []])),
