...
ALTER TABLE preguntas ADD COLUMN IF NOT EXISTS texto          JSONB       NOT NULL DEFAULT '{}';
ALTER TABLE preguntas ADD COLUMN IF NOT EXISTS actualizada_en TIMESTAMPTZ NOT NULL DEFAULT NOW();
