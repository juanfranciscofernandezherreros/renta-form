...
CREATE INDEX IF NOT EXISTS idx_preguntas_adicionales_activa
    ON preguntas_adicionales (activa);

CREATE OR REPLACE TRIGGER trg_preguntas_adicionales_actualizado_en
BEFORE UPDATE ON preguntas_adicionales
FOR EACH ROW EXECUTE FUNCTION fn_set_actualizado_en();

-- =============================================================
--  TABLA: declaracion_pregunta
--  Relación many-to-many entre declaraciones y preguntas.
--  Almacena la asignación y la respuesta del contribuyente.
-- =============================================================
...
CREATE INDEX IF NOT EXISTS idx_decpregunta_declaracion
    ON declaracion_pregunta (declaracion_id);

CREATE INDEX IF NOT EXISTS idx_decpregunta_pregunta
    ON declaracion_pregunta (pregunta_id);
